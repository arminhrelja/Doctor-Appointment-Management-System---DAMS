                    ...
                    <div className="flex h-30 items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="sm:flex sm:gap-4">
                                <Link className="rounded-md bg-blue-700 px-5 py-2.5 
                                  text-lg font-medium
                                text-white shadow-sm" to={"/login"}>
                                    Login
                                </Link>

                                <div className="hidden sm:flex">
                                    <Link className="rounded-md bg-gray-100 px-5 py-2.5 text-lg font-medium text-blue-700"
                                        to="/register">
                                        Register
                                    </Link>
                                </div>
